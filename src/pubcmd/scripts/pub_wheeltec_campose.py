...
def airpub():
    pub_pose = rospy.Publisher("/2dgazebo/wheeltec_camera_pose",PoseStamped,queue_size=1)
    rospy.init_node('pub_wheeltec_campose',anonymous=True)
    rate = rospy.Rate(10)
    ...
    while not rospy.is_shutdown():
         ...
         try:
            (trans,rot) = listener.lookupTransform('odom_combined', 'd400_depth_optical_frame', rospy.Time(0))
         ...
         count+=1
         pose_msg.header.frame_id = 'd400_depth_optical_frame'
