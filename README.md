...
- [2023/12]: 🔥 We released the code of EH-Nav in the simulation environment. The pre-trained model can be downloaded at  [OneDrive](https://connecthkuhk-my.sharepoint.com/:u:/g/personal/u3009632_connect_hku_hk/EYEGifzHhjxEjWtk9fZQ4-MB69iLUPaU60w_FGJU4sQ9Qg?e=w3yael)
...
```
 git clone https://github.com/jmwang0117/EH-Nav.git
```
